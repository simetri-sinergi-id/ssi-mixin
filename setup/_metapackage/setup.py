...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-ssi_field_date_callable_attribute>=15.0dev,<15.1dev',
        'odoo-addon-ssi_localdict_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_m2o_configurator_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_master_data_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_multiple_approval_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_operating_unit_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_partner_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_policy_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_pricelist_mixin>=15.0dev,<15.1dev',
        ...
        'odoo-addon-ssi_qr_code_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_reference_document_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_related_attachment_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_res_currency_m2o_configurator_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_res_partner_bank_m2o_configurator_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_res_partner_m2o_configurator_mixin>=15.0dev,<15.1dev',
        'odoo-addon-ssi_res_users_m2o_configurator_mixin>=15.0dev,<15.1dev',
